...
| 2 | 延長コード -> 屋外用電源ボックス | Hrensaw/Hrensaw級のIP54電源ボックス | ACアダプタと差込口が無理なく入る内寸 |
| 3 | 100V -> 5V | USB-C ACアダプタ | PSE、箱内発熱、ポート数 |
| 4 | 電源ボックス -> ダイソーケース | USB-C 1m-2m | 実際の距離。3mは離す時だけ |
| 5 | ダイソーケース入口 | セパレートキャプコン または ゴムグロメット | USB-Cコネクタが通る穴径、ケーブル外径 |
