...
| 候補 | Amazon目安 | 適合ケーブル径 | 取付穴 | USB-Cコネクタ通線 | 屋外向き | 採用候補 | 見方 |
|---|---:|---|---|---|---|---|---|
| オーム OA-WH16-06/10E | Amazon検索 | 6〜10mm | 21mm | ◎ | ◎ | ◎ | UGREEN 100W 1mの約6.4mmに合いやすい。穴が小さく、透明ケース向き |
| オーム OA-WH22-06/13E | Amazon検索 | 6〜13mm | 28mm | ◎ | ◎ | ◎ | コネクタを通しやすいが穴が大きい。M5箱や厚めケース向き |
| オーム OA-WH22-06/13 | Amazon検索 | 6〜13mm | 28mm | ◎ | × | × | 黒ゴムの耐油型。公式注意では直射日光の連続曝露を避ける扱い |
| AVC 防水スーパーグランド MG20A-10-SD系 | Amazon検索 | 6〜10mm | 20.5〜21.0mm | ◎ | ◎ | × | IP68でスリット入りシール。よさそうだがAmazon入手性と型番確認が必要 |
| 汎用M20分割ケーブルグランド | Amazon検索 | 商品ごと | 20mm級 | × | × | × | 安いが仕様根拠が弱い。防水等級、適合径、スリット構造の確認が必要 |
| ゴムグロメット + 自己融着テープ | 低価格 | 現物合わせ | 現物合わせ | ◎ | × | × | 最安の逃げ道。防水等級は期待せず、防滴補助として使う |
