...
| 16 | 外気温湿度・気圧 | M5Stack ENV III | 1 | ベランダの温度、湿度、気圧を見る | 防水ではない。箱内では箱内環境になるため、外気用は小型百葉箱/自然通風シェルター内に置く |
| 17 | 照度 | M5Stack Unit DLight / BH1750系照度センサー | 1 | 北向きベランダの明るさをlxで見る | 防水ではない。透明カバーや小型センサーシェルターで雨を避け、空が見える向きへ |
...
| 21 | ENV III保護 | フィールドプロ FP1806 小型自然通風シェルター、またはAmazonの小型自然通風シェルター/放射シールド | 1 | ENV IIIを外気測定用に保護する | 雨と直射日光を避けつつ空気を通す。密閉箱は外気温湿度にならない |
| 22 | DLight保護 | 透明フタ付き小型ケース、透明アクリルカバー、または透明防滴カバー | 1 | 照度センサーを雨から守る | 百葉箱内だと暗くなる。照度は空が見える透明カバー側へ分ける |
