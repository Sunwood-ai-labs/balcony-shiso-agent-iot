...
|---|---:|---|---|---|
| 最小API構成 | 8,000〜15,000円 | 温湿度、照度 | ◎ MQTT/HTTP自由 | 雨風なし。北向き栽培判断ならまず成立 |
| 大葉向け常設API構成 | 18,000〜30,000円 | 温湿度、照度、UV、土壌水分 | ◎ MQTT/HTTP自由 | 風雨より栽培に効く情報へ寄せる案 |
| フル気象自作 | 30,000〜45,000円 | 温湿度、照度、UV、風速、風向、雨量、土壌水分 | ◎ MQTT/HTTP自由 | 防水、支柱、校正、風雨センサー固定が大変 |
