...
| 区分 | 候補 | 価格 | PSE | PD | GaN | 高耐久 | 国内メーカー | 本命度 |
|---|---|---:|---|---|---|---|---|---|
| ACアダプタ | UGREEN 30W GaN / 2C1A | 1,500〜2,000円級 | ○ | ◎ | ◎ | △ | × | ◎ |
| ACアダプタ | オウルテック 30W PD | 3,000円前後 | ◎ | ◎ | ○ | ○ | ◎ | ○ |
| ACアダプタ | エレコム 30W PD | 2,000〜5,000円級 | ◎ | ◎ | △ | ○ | ◎ | ○ |
| ケーブル | UGREEN 100W 1m/2m ナイロン | 800〜1,800円級 | - | ◎ | - | ○ | × | ◎ |
| ケーブル | Belkin BoostCharge 100W 2m | 1,300円前後〜 | - | ◎ | - | ◎ | × | ◎ |
| ケーブル | オウルテック 100W 2m 高耐久 | 価格要確認 | - | ◎ | - | ◎ | ◎ | ○ |

記号: ◎=強い、○=使える、△=条件つき、×=弱い、-=対象外。
