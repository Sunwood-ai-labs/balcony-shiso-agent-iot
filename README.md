...
まず作るのはこれ。UVは今回の最低要件から外す。理由は、大葉の初期判断に必要なのはまず温湿度と照度で、UVは透明ケース素材によって値が狂いやすいから。

```text
透明ケース簡易版

上面/前面: 透明
  - BH1750/TSL2591 照度センサーを空が見える向きに固定

内部
  - M5StickS3 または ESP32
  - SHT31/SHT35 または BME280 温湿度センサー
  - USB-C 5V入力
  - 乾燥剤
...
初回は防水性能より「加工しやすさ、透明面、余裕」を優先する。完全防水箱ではないので、雨が直接当たり続ける場所には置かない。

| 優先 | ダイソー候補 | 価格 | サイズ | 判断 |
|---:|---|---:|---|---|
| 1 | フタ付収納ケース（透明）M | 330円 | 内寸21.5 x 32 x 12.3cm / 外寸23.5 x 13.5 x 33.8cm | 本命。M5/ESP32、USB-C曲げ、乾燥剤、センサー固定の余裕がある |
| 2 | 積み重ね収納ボックス（深型） | 220円 | 15.2 x 21.5 x 16.3cm | 高さに余裕。スリット加工しやすい |
| 3 | 積み重ね収納ボックス | 110円 | 15.2 x 21.5 x 8.3cm | 薄め。ESP32なら可、M5とUSB-C曲げは実物確認 |
| 4 | クリアボックスMサイズ | 110円 | 約13.5 x 9.7 x 7.1cm | 小さい。ESP32最小構成向け |
| 5 | 透明収納ケース（フタ付、B） | 220円 | 27 x 5.7 x 10.4cm | 長いが浅い。照度センサー別箱や薄型配置向け |
